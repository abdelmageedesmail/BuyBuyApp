...
/**
 * Created by IDotmasr on 2/26/2018.
 */
...
public class DistanceCalculator {
    ...
    public double greatCircleInKilometers(double lat1, double long1, double lat2, double long2) {
        ...
        System.out.print("dissss " + 6371.01 * acos(sin(phi1) * sin(phi2) + cos(phi1) * cos(phi2) * cos(lam2 - lam1)));
        double v = 6371.01 * acos(sin(phi1) * sin(phi2) + cos(phi1) * cos(phi2) * cos(lam2 - lam1));
